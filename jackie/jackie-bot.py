...
def main():
    ...
    exchange.send_limit_add_message(symbol="BOND", dir=Dir.BUY, price=999, size=100)
    exchange.send_limit_add_message(symbol="BOND", dir=Dir.SELL, price=1001, size=100)
